...
# https://m.tianqi.com/lishi/shenzhen/202102.html
def main():
...
#     url = "https://m.tianqi.com/lishi/shenzhen/" + i + ".html"
    ...
    for i in range(30):
        for weather in weather_list:
            weather_date = weather.select('div[class="wi190"]')[i].text
            weather_temprature = weather.select('div[class="wi140"')[i].text
